...
public class BossAbilities : MonoBehaviour 
{
    ...
    public MeatballAbility Meatball { get; private set; }
    public SpawnEnemiesAbility SpawnEnemies { get; private set; }
    ...
    public void Init(BossLevel owner)
    {
        ...
        Meatball = new MeatballAbility();
        SpawnEnemies = new SpawnEnemiesAbility();
